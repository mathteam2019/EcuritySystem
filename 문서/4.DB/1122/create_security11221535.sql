...
(
   ...
   MODE_ID              bigint comment '模式ID    (new)',
   MODE_NAME            varchar(200) comment '模式名称 (new)',
   TASK_STATUS          varchar(10) comment '状态，系统字典表 DICTIONARY_ID=11',
   WORKFLOW_ID          varchar(10) comment '流程ID',
...
(
   ...
   ASSIGN_START_TIME    timestamp comment '开始时间',
   ASSIGN_END_TIME      timestamp comment '结束时间',
   ASSIGN_TIMEOUT       varchar(10) comment '分派超时    超时、不超时        sys_dictionary_data   dictionary_id=17',
   CREATEDBY            bigint comment '记录创建人',
   CREATEDTIME          timestamp comment '记录创建时间',
   EDITEDBY             bigint comment '记录修改人',
   EDITEDTIME           timestamp comment '记录修改时间',
...
(
   ...
   TASK_ID              bigint not null comment '任务ID',
   HAND_TASK_RESULT     varchar(10) comment '任务结论  手检结论   TREU查获，FALSE 未查获   sys_device_dictionary_data  dictionary_id=6',
   HAND_GOODS           varchar(255) comment '查获物品 （多条数据字符串分隔）     查获物 sys_dictionary_data   dictionary_id=17 ',
   HAND_GOODS_GRADE     varchar(10) comment '查获物品等级',
   HAND_COLLECT_SIGN    varchar(10) comment '收藏标识',
   HAND_ATTACHED_ID     bigint comment '附件ID',
   HAND_COLLECT_LABEL   varchar(10) comment '收藏标签',
   HAND_APPRAISE        varchar(10) comment '评价判图     漏报，误报    sys_dictionary_data   dictionary_id=17 ',
   CREATEDBY            bigint comment '记录创建人',
   CREATEDTIME          timestamp comment '记录创建时间',
   EDITEDBY             bigint comment '记录修改人',
   EDITEDTIME           timestamp comment '记录修改时间',
...
(
   ...
   WORKFLOW_ID          bigint comment '流程ID',
   HAND_DEVICE_ID       bigint comment '设备ID',
   HAND_RESULT          varchar(10) comment '手检结论   TREU查获，FALSE 未查获   sys_device_dictionary_data  dictionary_id=6',
   HAND_START_TIME      timestamp comment '开始时间',
   HAND_END_TIME        timestamp comment '结束时间',
   HAND_USER_ID         bigint comment '手检员',
   CREATEDBY            bigint comment '记录创建人',
...
(
   ...
   SCAN_DEVICE_ID       bigint comment '设备ID',
   SCAN_IMAGE_ID        bigint comment '扫描图像ID',
   SCAN_ATR_RESULT      varchar(10) comment 'ATR结论      TRUE报警、FALSE通过   sys_device_dictionary_data  dictionary_id=8',
   SCAN_INVALID         varchar(10) comment 'true有效扫描\false 无效扫描  sys_device_dictionary_data  dictionary_id=4',
   SCAN_FOOT_ALARM      varchar(10) comment '脚步报警    TRUE报警、FALSE不报警  sys_device_dictionary_data  dictionary_id=9',
   SCAN_START_TIME      timestamp comment '开始时间',
   SCAN_END_TIME        timestamp comment '结束时间',
   SCAN_POINTSMAN_ID    bigint comment '引导员ID',
...
(
   ...
   WORKFLOW_ID          bigint comment '流程ID',
   JUDGE_DEVICE_ID      bigint comment '判图站',
   JUDGE_RESULT         varchar(10) comment '判图结论   有嫌疑true、无嫌疑false     sys_device_dictionary_data     dictionary_id=5',
   JUDGE_TIMEOUT        varchar(10) comment '判图超时    超时、不超时        sys_dictionary_data   dictionary_id=17',
   JUDGE_SUBMITRECTS    varchar(255) comment '判图提交嫌疑框  new（json字符串，包括添加的嫌疑框和删除的嫌疑框）',
   JUDGE_TIME           varchar(255) comment '判图时间',
   JUDGE_START_TIME     timestamp comment '开始时间',
   JUDGE_END_TIME       timestamp comment '结束时间',
...
(
   ...
   SEIZED_GOODS         varchar(255) comment '查获物品   sys_dictionary_data  DICTIONARY_ID=16',
   SEIZED_GOODS_TYPE    varchar(10) comment '物品分类    sys_dictionary_data  DICTIONARY_ID=14',
   SEIZED_GOODS_LEVEL   varchar(10) comment '物品级别   sys_dictionary_data   DICTIONARY_ID=15',
   CREATEDBY            bigint comment '记录创建人',
   CREATEDTIME          timestamp comment '记录创建时间',
   EDITEDBY             bigint comment '记录修改人',
   EDITEDTIME           timestamp comment '记录修改时间',
...
alter table SER_SEIZED_GOODS comment '查获物 new 1121';
