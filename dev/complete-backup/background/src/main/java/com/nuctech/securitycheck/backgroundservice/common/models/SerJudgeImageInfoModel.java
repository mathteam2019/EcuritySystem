...
@ApiModel(value = "SerJudgeImageInfoModel", description = "后台服务向判图站推送待判图图像信息")
public class SerJudgeImageInfoModel {

    @NotBlank
    @ApiModelProperty(value = "安检仪 GUID")
    private String guid;

    @ApiModelProperty(value = "安检仪扫描数据")
