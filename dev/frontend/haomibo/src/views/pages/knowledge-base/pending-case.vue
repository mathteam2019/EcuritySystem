        ...
        <b-row class="pt-2">
          <b-col cols="8">
            <b-row>
              ...
              <b-col>
                <b-form-group v-if="filter.modeName == null" :label="$t('knowledge-base.task-result')">
                  <b-form-select v-model="filter.taskResult" :options="handResultOption" plain/>
                </b-form-group>
                <b-form-group v-if="filter.modeName === '1000001301' || filter.modeName === '1000001303'"
                              :label="$t('knowledge-base.task-result')">
                  <b-form-select v-model="filter.taskResult" :options="handResultOption2" plain/>
                </b-form-group>
                <b-form-group v-if="filter.modeName === '1000001302' || filter.modeName === '1000001304'"
                              :label="$t('knowledge-base.task-result')">
                  <b-form-select v-model="filter.taskResult" :options="handResultOption1" plain/>
                </b-form-group>
              </b-col>
              <b-col>
          ...
          <b-col cols="4" class="d-flex justify-content-end align-items-center">
            <div>
              ...
              <b-button size="sm" class="ml-2" variant="outline-info default"
                        :disabled="checkPermItem('pending_knowledge_export')" @click="onExportButton()">
            ...
            <div class="table-wrapper table-responsive">
              ...
              >
                ...
                <template slot="mode" slot-scope="props">
                  <div v-if="props.rowData==null"></div>
                  <div v-else>
                ...
                <template slot="operating" slot-scope="props">
                  <div>
                    ...
                    <b-button
                      ...
                      @click="showModal('dismiss', props.rowData.caseId)">
                      <i class="icofont-ban"/>
                    </b-button>
                  </div>
                </template>
            ...
            <b-row style="float: right;">
              <b-col class="control-group">
                ...
                <div class="switch-wrapper">
                  ...
                  <div class="switch">
                    <switches v-model="power" theme="custom" :disabled="checkPermItem('pending_knowledge_toggle')"
                              color="info"/>
                  </div>
                </div>
              </b-col>
        ...
        <b-col class="col-70" style="padding-right: 13px">
          <b-card class="h-100 d-flex flex-column right-card">
            <div style="height: 20px;">
              ...
              <div style="font-size: 15px; font-weight: bold;">{{$t('personal-inspection.pending')}}</div>
            </div>
                ...
                <b-row style="margin-top: 1rem">
                  <b-col cols="12" class="align-self-end text-right mt-3">
                    ...
                    <b-button size="sm" variant="danger default"
                              :disabled="checkPermItem('pending_knowledge_delete')"
                              @click="showModal('dismiss', caseId)">
    ...
    methods: {
      ...
      onExport() {
        ...
        if (checkedIds.length > 0) {
          downLoadFileFromServer(link, params, 'Knowledge-Pending', this.fileSelection);
