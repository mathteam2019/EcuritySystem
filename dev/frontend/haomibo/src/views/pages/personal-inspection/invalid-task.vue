          ...
          <b-col cols="4" class="d-flex justify-content-end align-items-center">
            <div>
              ...
              <b-button size="sm" class="ml-2" variant="outline-info default"
                        :disabled="checkPermItem('invalid_task_export')" @click="onExportButton()">
                <i class="icofont-share-alt"/>&nbsp;{{ $t('log-management.export')}}
              </b-button>
              <b-button size="sm" class="ml-2" variant="outline-info default"
                        :disabled="checkPermItem('invalid_task_print')" @click="onPrintButton()">
        ...
        <b-col class="col-70" style="padding-right: 13px">
          <b-card class="h-100 d-flex flex-column right-card">
            <div style="height: 20px;">
              ...
              <div style="font-size: 15px; font-weight: bold;">{{$t('personal-inspection.invalid')}}</div>
            </div>
     ...
     setOldBrightness(){
      ...
      onExport() {
        ...
        if (checkedIds.length > 0 && this.fileSelection !== null) {
          downLoadFileFromServer(link, params, 'Invalid-Task', this.fileSelection);
