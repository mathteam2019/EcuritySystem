            ...
            return {
                ...
                vuetableItems: {
                    ...
                    fields: [
                        ...
                        {
                            name: 'access-time',
                            title: this.$t('log-management.device-log.access-time'),
                        ...
                        {
                            name: 'start-time',
                            title: this.$t('log-management.device-log.action'),
                        ...
                        },
                        {
                            ...
                            title: this.$t('log-management.device-log.access-ip'),
                        ...
                        {
                            name: 'node-type',
                            title: this.$t('log-management.device-log.access-user'),
                            sortField: 'node-type',
                            titleClass: 'text-center',
                            dataClass: 'text-center'
                        },
