...
export const colorOptions = [
  {id: 'en', name: 'Black', direction: 'ltr', icon: '/assets/img/flags/united-kingdom.svg'},
  {id: 'zh', name: '中文', direction: 'ltr', icon: '/assets/img/flags/china.svg'}
];
...
//export const apiBaseUrl = 'http://192.168.2.115:4546';
//export const apiBaseUrl = 'http://192.168.2.110:4546';
