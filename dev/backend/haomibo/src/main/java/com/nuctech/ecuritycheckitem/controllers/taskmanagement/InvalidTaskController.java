...
public class InvalidTaskController extends BaseController {
    ...
    public Object invalidTaskGetById(
        ...
        filters.addFilter(ModelJsonFilters.FILTER_SER_TASK, SimpleBeanPropertyFilter.filterOutAllExcept("taskId", "taskNumber", "taskStatus", "field", "serScan", "serJudgeGraph", "serHandExamination", "workFlow", "scanDeviceImages", "history", "serCheckResult", "note")) //only return specified fields from task model
                ...
                .addFilter(ModelJsonFilters.FILTER_SER_JUDGE_GRAPH, SimpleBeanPropertyFilter.filterOutAllExcept("judgeDevice", "judgeResult", "judgeTimeout", "judgeSubmitrects", "judgeUser", "judgeStartTime", "judgeEndTime")) //only return "judgeDevice", "judgeUser", "judgeStartTime", "judgeEndTime" from SerJudgeGraph model
                .addFilter(ModelJsonFilters.FILTER_SER_HAND_EXAMINATION, SimpleBeanPropertyFilter.filterOutAllExcept("handResult", "handDevice", "handUser", "handStartTime", "handEndTime")) //only return "handDevice", "handUser", "handStartTime", "handEndTime" from SerHandExamination model
