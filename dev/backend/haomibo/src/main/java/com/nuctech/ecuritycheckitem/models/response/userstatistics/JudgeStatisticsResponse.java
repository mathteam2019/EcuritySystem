 ...
 *
 * 项目：	Haomibo V1.0（Simplified JudgeStatisticsPaginationResponse）
 * 文件名：	JudgeStatisticsPaginationResponse.java
 * 描述：	Simplified paginated JudgeStatistics model
 * 作者名：	Tiny
 * 日期：	2019/12/04
 */
...
public class JudgeStatisticsResponse {
    JudgeStatisticsModelForPreview totalStatistics; //total statistics
    Map<Integer, JudgeStatisticsModelForPreview> detailedStatistics; //detailed statistics
