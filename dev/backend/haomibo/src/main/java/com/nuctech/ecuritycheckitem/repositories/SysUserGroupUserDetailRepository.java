...
@Repository
public interface SysUserGroupUserDetailRepository extends
        JpaRepository<SysUserGroupUserDetail, Long>,
        PagingAndSortingRepository<SysUserGroupUserDetail, Long>,
        QuerydslPredicateExecutor<SysUserGroupUserDetail> {
