...
@Repository
public interface HistoryTableInvalidRepository extends
        JpaRepository<HistorySimplifiedForInvalidTableManagement, Long>,
        PagingAndSortingRepository<HistorySimplifiedForInvalidTableManagement, Long>,
        QuerydslPredicateExecutor<HistorySimplifiedForInvalidTableManagement> {
