...
@Repository
public interface HistoryTableRepository extends
        JpaRepository<HistorySimplifiedForHistoryTableManagement, Long>,
        PagingAndSortingRepository<HistorySimplifiedForHistoryTableManagement, Long>,
        QuerydslPredicateExecutor<HistorySimplifiedForHistoryTableManagement> {
