 ...
 *
 * 项目：	Haomibo V1.0（SerCheckResultSimplifiedForProcessTaskManagement）
 * 文件名：	SerCheckResultSimplifiedForProcessTaskManagement.java
 * 描述：	Simplified SerCheckResult Model
 * 作者名：	Tiny
 * 日期：	2019/12/27
 */
