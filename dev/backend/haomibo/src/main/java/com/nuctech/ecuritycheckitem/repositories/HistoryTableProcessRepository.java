...
@Repository
public interface HistoryTableProcessRepository extends
        JpaRepository<HistorySimplifiedForProcessTableManagement, Long>,
        PagingAndSortingRepository<HistorySimplifiedForProcessTableManagement, Long>,
        QuerydslPredicateExecutor<HistorySimplifiedForProcessTableManagement> {
