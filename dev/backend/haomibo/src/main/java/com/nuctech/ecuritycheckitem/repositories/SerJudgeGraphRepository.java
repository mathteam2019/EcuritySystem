...
public interface SerJudgeGraphRepository extends
    ...
    @Query(value = "SELECT\n" +
            ...
            "\tand g.JUDGE_DEVICE_ID = :deviceId\n" +
            "\tand t.SCENE = :fieldId\n" +
            "GROUP BY\n" +
            "\t MONTH ( JUDGE_START_TIME )", nativeQuery = true)
    public List<Object> getStatisticsAllByMonth(
            @Param("fieldId") long fieldId,
            @Param("deviceId") long deviceId);


    @Query(value = "SELECT\n" +
            "\t DAY ( JUDGE_START_TIME ) Date,\n" +
            "\tcount( JUDGE_ID ) total,\n" +
            "\tsum( IF ( s.SCAN_ATR_RESULT LIKE 'true' AND g.JUDGE_RESULT LIKE 'true', 1, 0 ) ) suspiction,\n" +
            "\tsum( IF ( s.SCAN_ATR_RESULT LIKE 'false' AND g.JUDGE_RESULT LIKE 'false', 1, 0 ) ) noSuspiction,\n" +
            "\tsum( IF ( ( wf.MODE_ID = 11 OR wf.MODE_ID = 10 ), 1, 0 ) ) AS atrResult,\n" +
            ...
            "\ts.SCAN_INVALID LIKE 'true'\n" +
            "GROUP BY\n" +
            "\t DAY ( JUDGE_START_TIME )", nativeQuery = true)
    public List<Object> getStatisticsAllByDay();


    @Query(value = "SELECT\n" +
            "\t FLOOR((DayOfMonth(JUDGE_START_TIME)-1) / 7) + 1 as time,\n" +
            "\tcount( JUDGE_ID ) total,\n" +
            "\tsum( IF ( s.SCAN_ATR_RESULT LIKE 'true' AND g.JUDGE_RESULT LIKE 'true', 1, 0 ) ) suspiction,\n" +
            "\tsum( IF ( s.SCAN_ATR_RESULT LIKE 'false' AND g.JUDGE_RESULT LIKE 'false', 1, 0 ) ) noSuspiction,\n" +
            "\tsum( IF ( ( wf.MODE_ID = 11 OR wf.MODE_ID = 10 ), 1, 0 ) ) AS atrResult,\n" +
            ...
            "\ts.SCAN_INVALID LIKE 'true'\n" +
            "GROUP BY\n" +
            "\t FLOOR((DayOfMonth(JUDGE_START_TIME)-1) / 7) + 1", nativeQuery = true)
    public List<Object> getStatisticsAllByWeek();

    @Query(value = "SELECT\n" +
            "\t HOUR ( JUDGE_START_TIME ) Date,\n" +
            "\tcount( JUDGE_ID ) total,\n" +
            "\tsum( IF ( s.SCAN_ATR_RESULT LIKE 'true' AND g.JUDGE_RESULT LIKE 'true', 1, 0 ) ) suspiction,\n" +
            "\tsum( IF ( s.SCAN_ATR_RESULT LIKE 'false' AND g.JUDGE_RESULT LIKE 'false', 1, 0 ) ) noSuspiction,\n" +
            "\tsum( IF ( ( wf.MODE_ID = 11 OR wf.MODE_ID = 10 ), 1, 0 ) ) AS atrResult,\n" +
            ...
            "\ts.SCAN_INVALID LIKE 'true'\n" +
            "GROUP BY\n" +
            "\t HOUR ( JUDGE_START_TIME )", nativeQuery = true)
    public List<Object> getStatisticsAllByHour();

    @Query(value = "SELECT\n" +
            "\t YEAR ( JUDGE_START_TIME ) as time,\n" +
            "\tcount( JUDGE_ID ) total,\n" +
            "\tsum( IF ( s.SCAN_ATR_RESULT LIKE 'true' AND g.JUDGE_RESULT LIKE 'true', 1, 0 ) ) suspiction,\n" +
            "\tsum( IF ( s.SCAN_ATR_RESULT LIKE 'false' AND g.JUDGE_RESULT LIKE 'false', 1, 0 ) ) noSuspiction,\n" +
            "\tsum( IF ( ( wf.MODE_ID = 11 OR wf.MODE_ID = 10 ), 1, 0 ) ) AS atrResult,\n" +
            ...
            "\ts.SCAN_INVALID LIKE 'true'\n" +
            "GROUP BY\n" +
            "\t YEAR ( JUDGE_START_TIME )", nativeQuery = true)
    public List<Object> getStatisticsAllByYear();

    @Query(value = "SELECT\n" +
            "\t MONTH ( JUDGE_START_TIME ) / 4 + 1 as time,\n" +
            "\tcount( JUDGE_ID ) total,\n" +
            "\tsum( IF ( s.SCAN_ATR_RESULT LIKE 'true' AND g.JUDGE_RESULT LIKE 'true', 1, 0 ) ) suspiction,\n" +
            "\tsum( IF ( s.SCAN_ATR_RESULT LIKE 'false' AND g.JUDGE_RESULT LIKE 'false', 1, 0 ) ) noSuspiction,\n" +
            "\tsum( IF ( ( wf.MODE_ID = 11 OR wf.MODE_ID = 10 ), 1, 0 ) ) AS atrResult,\n" +
            ...
            "\ts.SCAN_INVALID LIKE 'true'\n" +
            "GROUP BY\n" +
            "\t MONTH ( JUDGE_START_TIME ) / 4 + 1", nativeQuery = true)
    public List<Object> getStatisticsAllByQuarter();
