...
public interface ArchiveService {
     ...
     * @return
     */
    PageResult<SerArchive> getArchiveListByPage(String sortBy, String order, String archiveName, Long templateId, String status, Long categoryId, int currentPage, int perPage);
     ...
     * @return
     */
    List<SerArchive> getExportListByFilter(String sortBy, String order, String archiveName, Long templateId, String status, Long categoryId, boolean isAll, String idList);
