...
@Repository
public interface SerTaskTableRepository extends
        JpaRepository<SerTaskSimplifiedForProcessTableManagement, Long>,
        PagingAndSortingRepository<SerTaskSimplifiedForProcessTableManagement, Long>,
        QuerydslPredicateExecutor<SerTaskSimplifiedForProcessTableManagement> {
