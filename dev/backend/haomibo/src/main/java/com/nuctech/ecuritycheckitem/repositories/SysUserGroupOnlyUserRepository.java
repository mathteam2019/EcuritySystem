...
@Repository
public interface SysUserGroupOnlyUserRepository extends
        JpaRepository<SysUserGroupOnlyUser, Long>,
        PagingAndSortingRepository<SysUserGroupOnlyUser, Long>,
        QuerydslPredicateExecutor<SysUserGroupOnlyUser> {
