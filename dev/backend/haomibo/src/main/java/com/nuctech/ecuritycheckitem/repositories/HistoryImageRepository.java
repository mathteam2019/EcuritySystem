...
@Repository
public interface HistoryImageRepository extends
        JpaRepository<HistorySimplifiedForHistoryImageManagement, Long>,
        PagingAndSortingRepository<HistorySimplifiedForHistoryImageManagement, Long>,
        QuerydslPredicateExecutor<HistorySimplifiedForHistoryImageManagement> {
